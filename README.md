...
2026-09-08 又按同一标准回溯了九家厂商的“重要小版本”：新增 45 条有独立官方发布证据、且带来旗舰定位或明显能力跃迁的记录。完整纳入项、排除项与暂缓理由见 [`data/important-version-audit-2026-09-08.json`](data/important-version-audit-2026-09-08.json)。

## 收录与日期口径

- 收录通用旗舰跨代发布、重要推理模型，以及有独立官方发布公告和明确能力跃迁证据的“重要小版本”。例如官方将小版本定位为旗舰/最强型号、性能新前沿，或确认其带来核心架构、模态、长程智能体等关键能力升级。首次已公开可用的预览版可收录，摘要注明阶段。
...
规则评分：官方源 40 / 新闻 10；明确已发布 20；旗舰或代际措辞 15；整数主代际或有强证据的重要小版本 10；有效时区时间戳 15。**达到 95 分还必须同时满足**官方来源、已核实正文/可信官方 RSS、独立明确的发布公告、旗舰/能力跃迁证据、非未来日期、非传闻。普通小版本继续进入审核；价格、延迟、渠道接入或一般质量优化不能单独构成收录理由。
